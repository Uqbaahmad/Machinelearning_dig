...
with st.form('form1', clear_on_submit=True):
    ...
    balance = st.number_input("Balance", min_value=0.0, max_value=9999999, value=100.0, step=.5)
    ...
    est_salary = st.slider("Estimted Salary", min_value=1000, max_value=999999, value = 2000, step=.5)
